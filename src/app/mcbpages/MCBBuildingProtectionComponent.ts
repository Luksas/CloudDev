            ...
            <table class="mcb-page">
                <tr>
                    <td class="bottom" style="text-align: center;">
                        <onoff-widget class="mcb-left" text='ENERGY_SAVING' reverse="false" value="165" modbus_key="HR_6" image="img-energysavingon" image_off="img-energysavingoff"></onoff-widget>
                        <onoff-widget class="mcb-left" *ngIf="show_recirculation" class="inline-block" text='FULL_RECIRCULATION' modbus_key="COILS_6" image="img-energysavingon" image_off="img-energysavingoff"></onoff-widget>
                        <range-widget class="inline-block" modbus_key='HR_6' min="160" max="300" caption="SET_POINT" step="0.5" coef="10"></range-widget>
                    </td>
                </tr>
            </table>
...
export class MCBBuildingProtectionComponent implements OnInit {
    ...
    ngOnInit(){
        ...
        this.command_service.sendReadCommands([
            new PartialReadCommand(1, 6, 1),
            new PartialReadCommand(1, 122, 1),
            new PartialReadCommand(3, 6, 1)
        ]);
    }
